...
void display(void)
{
   ...
   glUniform1f(loc_mouseX, mouseX);
   glUniform1f(loc_mouseY, mouseY);
   glutSolidTeapot(4);
...
int main(int argc, char** argv)
{
   ...
   loc_mouseX = shader1->getUniformLoc("mouseX");
   loc_mouseY = shader1->getUniformLoc("mouseY");
